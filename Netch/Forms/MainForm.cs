...
public partial class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        if (Flags.NoSupport)
            _mainFormText.Add(Name, new[] { "{0} ({1})", "NovaNetX VPN", "No Support" });
    ...
    private void Minimize()
    {
        ...
        {
            // 显示提示语
            NotifyTip(i18N.Translate("NovaNetX VPN is now minimized to the notification bar, double click this icon to restore."));
