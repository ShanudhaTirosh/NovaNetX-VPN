...
{
    public const string Owner = @"ShanudhaTirosh";
    public const string Repo = @"NovaNetX-VPN";

    public const string Name = @"NovaNetX VPN";
    public const string Copyright = @"Copyright © 2024 - 2026 Netch Solutions";
